...
vnum_pl='s/,/,2,54,0,3,10,0,1,54,0/g; s/1/,2,30,0,3,10,0,1,30,0/g; s/2/,2,31,0,3,10,0,1,31,0/g; s/3/,2,32,0,3,10,0,1,32,0/g; s/4/,2,33,0,3,10,0,1,33,0/g; s/5/,2,34,0,3,10,0,1,34,0/g; s/6/,2,35,0,3,10,0,1,35,0/g; s/7/,2,36,0,3,10,0,1,36,0/g; s/8/,2,37,0,3,10,0,1,37,0/g; s/9/,2,38,0,3,10,0,1,38,0/g; s/0/,2,39,0,3,10,0,1,39,0/g;'
...
function render()
{
    ...
    #_buff="$(echo "${_buff}" | sed "${vnum_pl}")"
    #_buff="$(echo "${_buff}" | sed "${regular}")"
    #_buff="$(echo "${_buff}" | sed "${maj_stl}")"
